...
implements IRootChunkStructure {
    ...
    public long responseView() {
        return 12L + this.IAudioInputStream();
    }
    ...
    public void DSP(IChunkReader zBNFgJwMMkkaOLFmIBSJWbh) throws OutOfChunkRangeException {
        ...
        this.FFT(zBNFgJwMMkkaOLFmIBSJWbh.AdditionalMetadataValue());
        for (byte by : byArray = zBNFgJwMMkkaOLFmIBSJWbh.FFT(4).array()) {
            this.DSP = this.DSP + (char)by;
        }
        this.FFT = zBNFgJwMMkkaOLFmIBSJWbh.FFT(8).getLong();
    ...
    protected void DSP(long l) {
        this.AdditionalMetadataValue = l;
    }

    protected void FFT(long l) {
        this.responseView = l;
    }
}
